...
**DAP_L4_ModelDevelopment_Python.ipnyb** Development of different prediction models such as linear and multiple-linear regression. As well as model validation using visualization and numeric tools. *Do I know if the dealer is offering fair value for my trade-in? Do I know if I put a fair value on my car?*
